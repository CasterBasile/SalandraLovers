document.addEventListener("DOMContentLoaded", function() {
    ...
    function createBannerElement(eventData) {
      ...
      bannerElement.addEventListener("click", function() {
        ...
        audioSource.src = eventData.audio;
        audioPlayer.load();
